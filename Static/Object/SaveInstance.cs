...
//     //                 foreach(object key in ((Dictionary<object,object>)o).Keys){
//     //                     object value;
//     //                     ((Dictionary<object,object>)o).TryGetValue(key, out value);

//     //                     dict.Add(ParseChildData(f,key),ParseChildData(f,value) );
//     //                 }

                    
//     //                 parentDict.Add(f.Name, dict); 
//     //             }
//     //             else if (save.objectType.GetGenericTypeDefinition() == typeof(List<>)){
